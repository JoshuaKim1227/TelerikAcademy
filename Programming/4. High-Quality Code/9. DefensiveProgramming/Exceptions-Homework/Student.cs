...
public class Student
{
    ...
    public IList<ExamResult> CheckExams()
    {
        if (this.Exams == null)
        {
            throw new ArgumentNullException("Exams", "Wow! Error happened!!! Exams cannot be null or empty.");
        }

        if (this.Exams.Count == 0)
        {
            throw new ArgumentOutOfRangeException("Exams", "There must be at least one exam.");
        }
