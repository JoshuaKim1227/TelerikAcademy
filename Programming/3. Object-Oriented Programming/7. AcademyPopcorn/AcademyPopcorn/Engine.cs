...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Ball ball;
        int sleepValue; // [Task 2]

        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepValue)
        {
        ...
        {
            while (this.ball.GetTopLeft().Row < AcademyPopcornMain.WorldRows)
            {
                this.renderer.RenderAll();

                System.Threading.Thread.Sleep(sleepValue); // [Task 2]
